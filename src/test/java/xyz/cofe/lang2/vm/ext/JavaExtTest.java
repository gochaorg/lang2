...
public class JavaExtTest {
    ...
    public void setUp() {
        ...
        URL logConf = JavaExtTest.class.getResource("JavaExtTest.xml");
    ...
    public void testLength() {
        ...
        assertParseExpressions("var test=\"abcde\"; test.length", "5");
    }
    ...
    public void testTemplate() {
        ...
        assertParseExpressions("var test=\"Hello {name} !\"; test.template( { name : \"Ko\" } )", "Hello Ko !");
    }
    ...
    public void listSize() {
        ...
        assertParseExpressions("var test=[ 1, 2, 3 ]; test.size", "3");
    }
    ...
    public void mapSize() {
        ...
        assertParseExpressions("var test={ a:1, b:2 }; test.size", "2");
    }
