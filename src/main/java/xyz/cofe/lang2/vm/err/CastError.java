 ...
 * @author gocha
 */
public class CastError extends RuntimeError
{
    /**
     * Конструктор
     ...
     * @param message Сообщение
     */
    public CastError(Object source,String message){
     ...
     */
    public CastError(Object source,String message,Throwable parent){
     ...
     * @param parent Вложенная ошибка
     */
    public CastError(String message,Throwable parent){
