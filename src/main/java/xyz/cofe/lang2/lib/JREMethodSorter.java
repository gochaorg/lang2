 ...
 * @author gocha
 */
public class JREMethodSorter implements Comparator<Method>
{
    //<editor-fold defaultstate="collapsed" desc="log Функции">
    private static void logFine(String message,Object ... args){
        Logger.getLogger(JREMethodSorter.class.getName()).log(Level.FINE, message, args);
    }
    
    private static void logFiner(String message,Object ... args){
        Logger.getLogger(JREMethodSorter.class.getName()).log(Level.FINER, message, args);
    }
    
    private static void logInfo(String message,Object ... args){
        Logger.getLogger(JREMethodSorter.class.getName()).log(Level.INFO, message, args);
    }

    private static void logWarning(String message,Object ... args){
        Logger.getLogger(JREMethodSorter.class.getName()).log(Level.WARNING, message, args);
    }
    
    private static void logSevere(String message,Object ... args){
        Logger.getLogger(JREMethodSorter.class.getName()).log(Level.SEVERE, message, args);
    }

    private static void logException(Throwable ex){
        Logger.getLogger(JREMethodSorter.class.getName()).log(Level.SEVERE, null, ex);
    }
    //</editor-fold>
    ...
    public JREMethodSorter(OrderField ... orderFields){
        if (orderFields== null) {            
    ...
    protected Field[] order = new Field[]{ Field.Name, Field.ParamCount, Field.ParamType };
    ...
    protected Map<Field,Boolean> orderInverse(){
        if( orderInverse==null ){
            ...
            orderInverse.put(Field.Name, Boolean.FALSE);
            orderInverse.put(Field.ParamCount, Boolean.FALSE);
            orderInverse.put(Field.ParamType, Boolean.FALSE);
        }
        return orderInverse;
    }
    ...
    public void resetOrder(){
        orderInverse = null;
        order = new Field[]{ Field.Name, Field.ParamCount, Field.ParamType };
    }
    ...
    public int compare(Method methodA, Method methodB) {
        int cmpName = methodA.getName().compareTo(methodB.getName());
